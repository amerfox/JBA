...
LuaTele = luatele.set_config{api_id=07373597,api_hash='9fd9892cf73639a742957682d4ab88009af6c7',session_name=Fast,token=Token}
function var(value)
...
{
{text = 'مطور الصانع', url = 't.me/IDIIS '},
},
}
...
{
{text = 'مطور السورس',type = 'text'},{text = 'السورس',type = 'text'},
},
{
...
if text == '. السورس' or text == 'مطور السورس' or text == 'مطور السورس ✭' then  
local UserId_Info = LuaTele.searchPublicChat("IDIIS")
...
local TestText = "*• مطور سورس ميلانو\n• 𝗡𝗔𝗠𝗘 : * ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*• 𝗕𝗜𝗢 : "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/IDIIS"}
},
}
...
photo = "https://t.me/gey9e/68"
local T = "*⌔︙اهلا بك عزيزي في مصنع البوتات\n⌔︙اقوم بصنع بوتات لـ حمايه المجموعات\n⌔︙يمكنك صنع بوت مجاني متطور وحديث\n⌔︙اختر ما تريد من الازرار التاليه\n⌔︙اضغط ( /milano ) لاضهار القائمه لصنع بوت .*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مطور السورس', url = 't.me/IDIIS '},
},
{  
{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = 't.me/IADFI '},
},
...
photo = "https://t.me/IADFI"
local T =[[
[𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𓊆 𝑱 𝑩 𝑨𓊇](t.me/IADFI )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مطور السورس', url = 't.me/IDIIS '},{text = 'تنصيب بوت مدفوع', url = 't.me/IDIIS'},
},
{
{text = 'قناة التحديثات', url = 't.me/IADFI '},{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = 't.me/IADFI '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
