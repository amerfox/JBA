...
if text == '𓊆 𝑱 𝑩 𝑨𓊇بيه يبني' or text == 'بنك مين يبني' then
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ توم ماعندها حساب بالبنك 🤣","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"\n*← 𓊆 𝑱 𝑩 𝑨𓊇 معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.Fastbots == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*← توم معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
...
return bot.sendText(msg.chat_id,msg.id,GetName.."\n\n*← مبروك احلي هدية ليك يبنلقمر 🌝 : "..Number.. " دولار 💵*\n⧫","md",true)
else
bot.sendText(msg.chat_id,msg.id, "← ما عندك حساب بنكي ","md",true)
end
end
...
return bot.sendText(msg.chat_id,msg.id,"⇜ ميصير تضارب الحين\n⇜ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"⇜ ميصير تستثمر الحين\n⇜ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"⇜ ميصير تلعب سحب الحين\n⇜ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "⇜ استعمل الامر كذا :\n\n⇜ `سحب` المبلغ","md",true)
end
if text == 'حظ' then
...
return bot.sendText(msg.chat_id,msg.id,"⇜ ميصير تلعب حظ الحين\n⇜ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "⇜ استعمل الامر كذا :\n\n⇜ `حظ` المبلغ","md",true)
end
...
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
return send(msg.chat_id,msg.id,"⇜ ميصير تحول لنفسك ","md",true)
end
...
send(msg.chat_id,msg.id, "⌯ حوالة صادرة من بنك 𓊆 𝑱 𝑩 𝑨𓊇\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المستلم : "..newss.."\n⇜ الحساب رقم : `"..text.."`\n⇜ نوع البطاقة : "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ : "..convert_mony.." دولار 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك 𓊆 𝑱 𝑩 𝑨𓊇\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المبلغ : "..convert_mony.." دولار 💵","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
else
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
return bot.sendText(msg.chat_id,msg.id, "← شخصيتك طيبة ميصير تاخذ رشوة","md",true)
end
local daddd = {"1", "2", "3", "4",}
...
bot.sendText(msg.chat_id,msg.id, "← ما عندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return bot.sendText(msg.chat_id,msg.id, "← شخصيتك شريرة ميصير تاخذ بخشيش","md",true)
end
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك طيبة ميصير تزرف العالم","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
...
return send(msg.chat_id,msg.id, "⇜ ميصير تزرفه فلوسه اقل من 200 دولار 💵","md",true)
end
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة ميصير تطلب الشرطة","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 1000000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 200000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 30000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 1000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 300000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 120000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 80000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 30000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تطور راتبك تحتاج مبلغ 3000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ ميصير تهجم فلوسك اقل من 100000 دولار 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "⇜ ميصير تهجم عليه فلوسه اقل من 100000 دولار 💵","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار ماسه بعملية وحدة\n⧫","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري فلوسك مش مكفيه","md",true)
end
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار قلاده بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سوار بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار خاتم بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." ماسه","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrmasname = Redis:get(Fast.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(Fast.."mgrmasprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." قلاده ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrkldname = Redis:get(Fast.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(Fast.."mgrkldprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سوار ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrswrname = Redis:get(Fast.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(Fast.."mgrswrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." خاتم ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrktmname = Redis:get(Fast.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(Fast.."mgrktmprice"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار قصر بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار فيلا بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار منزل بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." قصر","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrksrname = Redis:get(Fast.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(Fast.."akrksrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." فيلا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrfelname = Redis:get(Fast.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(Fast.."akrfelprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." منزل ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrmnzname = Redis:get(Fast.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(Fast.."akrmnzprice"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار طياره شبح بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار طياره سفر بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار طياره خاصه بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طيارة شبح ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airshbhname = Redis:get(Fast.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(Fast.."airshbhprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طيارة سفر ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airsfarname = Redis:get(Fast.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(Fast.."airsfarprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طيارة خاصه ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airkhasname = Redis:get(Fast.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(Fast.."airkhasprice"..msg.sender_id.user_id) or 0
...
if tonumber(airshbhnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طائرة شبح ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
if tonumber(airsfarnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طائرة سفر ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
if tonumber(airkhasnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." طائرة خاصه ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره فيلار بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره اكسنت بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره كامري بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره النترا بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره هايلكس بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره سوناتا بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "← ميصير تشتري اكثر من مليار سياره كورولا بعملية وحدة\n⧫","md",true)
end
ballance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة فيلار ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carrangname = Redis:get(Fast.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(Fast.."carrangprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة اكسنت ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local caraccename = Redis:get(Fast.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(Fast.."caracceprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة كامري ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carcamrname = Redis:get(Fast.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(Fast.."carcamrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة النترا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local caralntrname = Redis:get(Fast.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(Fast.."caralntrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة هايلكس ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carhilxname = Redis:get(Fast.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(Fast.."carhilxprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة سوناتا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carsonaname = Redis:get(Fast.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(Fast.."carsonaprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← ما عندك "..tonumber(coniss).." سيارة كورولا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carcoroname = Redis:get(Fast.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(Fast.."carcoroprice"..msg.sender_id.user_id) or 0
...
return send(msg.chat_id,msg.id, "⇜ ميصير تغيير اللقب فلوسك ماتكفي","md",true)
end
...
local nadebott = {"اشبيلية", "ريفر بلايت", "ريفر بلايت", "بوروسيا", "أياكس الهولندي", "ليون", "شاختار دونيتسك", "روما", "فياريال", "بوكا جونيورز", "نابولي", "بنفيكا", "فلامنجو", "ليستر سيتي", "بالمرسي", "ليل", "ريال سوسيداد", "ايندهوفن", "الأهلي المصري", "ال𓊆 𝑱 𝑩 𝑨𓊇 السعودي", "الاتحاد السعودي",}
...
return send(msg.chat_id,msg.id, "⇜ ميصير تشتري مساحة ارضك ماتكفي","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ ميصير تشتري فلوسك ماتكفي","md",true)
end
...
if (text == 'طرتت' or text == 'رفض') and msg.reply_to_message_id == 0 then
ballanceed = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id, "⇜ استعمل الامر كذا :\n\n⇜ `طرد` بالرد","md",true)
end
...
local coniss = coin(UserName)
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id, "← ما عندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
if tonumber(ballancee) < 1 then
return bot.sendText(msg.chat_id,msg.id, "← ما عندك تبرعات \n⧫","md",true)
end
local convert_mony = string.format("%.0f",ballancee)
