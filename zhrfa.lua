...
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
  {{text = '▴ زغرفه عادي ▴', data = msg.sender_id.user_id..'/normal_zk'},},
  {{text = '▴ زغرفه انلاين ▴', data = msg.sender_id.user_id..'/inline_zk'},},
...
return send(msg_chat_id,msg_id, "⌔︙اختر الزغرفه التي تريدها :\n\n"..anubis,"md",false,false,false,false,reply_markup)
end
-- z eng
...
return send(msg_chat_id,msg_id,"والله اني اعرف انته تفتهم بس انته تسويهه هيج عمدا دز هيج الزخرفه بهاي الصيغه \n▷ 𓂄𓆩###𓆪𓂁 ","md",true)
end
