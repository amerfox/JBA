...
'  شهر من أشهر العام له ذكرى جميلة وياك؟',
...
"إذا دخلت مُسابقة وربحت 5 مليون دولار ماذا تفعل بهم؟",
...
"هل تستطيع التنازل عن شيء تفضله من أجل إسعاد الاخرىن؟",
...
local txt = '⌔︙ بواسطه 「 ['..UserInfo.first_name..'](tg://user?id='..who_promot..')⁪⁬‌‌‌‌ 」\n⌔︙  تم تفعيل الگروب ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') تلقائياً\n✦'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return send(Sudo_Id,0,'*\n⌔︙ تم طرد البوت من گروب جديده \n⌔︙ اسم الگروب : '..Get_Chat.title..'\n⌔︙ ايدي الگروب :*`-100'..data.supergroup.id..'`\n⌔︙ تم مسح جميع البيانات المتعلقه بالگروب',"md")
end
...
if tonumber(Message_Edit.sender_id.user_id) == 1427981991 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 1427981991 then
data.The_Controller = 1
...
{{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = "https://t.me/IADFI"}},
}
}
...
return bot.answerCallbackQuery(data.id,"\n⦁ راح تلعب وياهم شلون وانت صاحب السؤال", true)
end
...
{
{text = '- اسماء گروبات وقنوات 🪁', data = IdUser..'/faou'},
},
{
...
data = {
{
{text = 'رجوع', data = IdUser..'/decor'},
},
{
{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = 't.me/IADFI'}, 
},
}
}
...
local Text = "* ⌔︙حسنا ارسل لي گروبك الان ⚡*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if text =='الغاء' then 
edit(ChatId,Msg_id, '* ⌔︙تم الغاء حفظ گروبك ⚡ *',"md",true)  
Redis:del(Fast..'SetGroupVip'..IdUser)
return false  
end 
Redis:del(Fast..'SetGroupVip'..IdUser)
Redis:set(Fast..'SOFI:Group:Vip'..IdUser,text)
local text = "* ⌔︙تم حفظ گروبك ⚡*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="تغيير گروبي",data="/ChangeGroupVip:"..IdUser},{text="حذف گروبي",data="/DelGroupVip:"..IdUser}},
{{text="وضع بوتي",data="/ChangeBotVip:"..IdUser}},{{text="وضع قناتي",data="/ChangeChanneVip:"..IdUser}},
...
{{text="وضع بوتي",data="/ChangeBotVip:"..IdUser}},{{text="وضع گروبي",data="/ChangeGroupVip:"..IdUser}},
...
msalm = "⌔︙ وسوينا لك حساب في بنك 𓊆 𝑱 𝑩 𝑨𓊇 🏦\n⌔︙ وشحنالك 50 دولار 💵 هدية\n\n⇜ رقم حسابك ↢ ( `"..cccall.."` )\n⇜ نوع البطاقة ↢ ( "..ccctype.." )\n⇜ فلوسك ↢ ( 50 دولار 💵 )\n⇜ شخصيتك : "..shakseshakse.."\n⇜ دولتك : 🇸🇾"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return bot.editMessageText(chat_id,msg_id, "⇠ ميصير تشتري فلوسك مش مكفيه","md",true)
end
...
return edit(ChatId,Msg_id, "⇜ ميصير تشتري اللاعب فلوسك ماتكفي","md",true)
end
...
return edit(ChatId,Msg_id, "⇜ ميصير تشتري فلوسك ماتكفي","md",true)
end
...
return edit(ChatId,Msg_id, "⇜ فلوسك قليلة ميصير تضمن\n𔔁","md",true)
...
{
{text = 'مطور الملف', url = 'http://t.me/T_0_M0'},
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '⦗ مطور السورس ⦘' , url = "tg://user?id="..UserId_Info.id }
},
{
{text = 'قناة السورس', url='http://t.me/'..chsource }
},
...
local zwg_id = anubis[2]
if tonumber(zwga_id) == tonumber(IdUser) then
return edit(ChatId, Msg_id, "لعد هتتجوزي امتي يا موكوسه ؟؟","md",false)
end
end
if Text and Text:match('(%d+)/zeng') then
local UserId = Text:match('(%d+)/zeng')
...
local zwg_id = anubis[2]
if tonumber(zwga_id) == tonumber(IdUser) then
return edit(ChatId, Msg_id, "لعد تريدني اجيبلك منو تتجوز ؟؟","md",false)
end
end
------
...
type = "photo",
media = ph,
caption = '[⌔︙اهلا بك سورس تومي ](t.me/IADFI) \n [⌔︙اقوه مصنع سورسات في التلكرام ](t.me/Msnambot) \n [⌔︙سورس تومي لمنع تصفيه المجموعات وحمايتها](t.me/IADFI) \n [⌔︙السورس مزود بجميع الالعاب والمميزات الحديثه و المطوره](t.me/IADFI) \n [⌔︙تابع قناه التحديثات والتطويرات ليصلك كل ما هو جديد لدينا](t.me/IADFI)',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗ اصنع بوتك الان ⇣ ⦘', url = "https://t.me/Msnambot"}
},
{
{text = 'رجوع', callback_data=IdUser..'/halo'},
},
{
{text = '⦗ ضيف البوت لـ مجموعتك ♡ ⦘', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
local ban = Msg_id/2097152/0.5
...
type = "photo",
media = ph,
caption = '[⌔︙اهلا بك سورس تومي ](t.me/IADFI)\n[⌔︙اقوه مصنع سورسات في التلكرام ](t.me/Msnambot)\n[⌔︙سورس تومي لمنع تصفيه المجموعات وحمايتها](t.me/IADFI)\n[⌔︙السورس مزود بجميع الالعاب والمميزات الحديثه و المطوره](t.me/IADFI)\n[⌔︙تابع قناة التحديثات والتطويرات ليصلك كل ما هو جديد لدينا](t.me/IADFI) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '** [⌔︙لأستخدام البوت اغاني وفيديو كول](t.me/IADFI)*\n*⌔︙اكتب ← /music ثم أضغط الأوامر*\n*⌔︙اكتب ← /key لاظهار كيبورد الاعضاء*\n*[⌔︙وظيفتي حماية المجموعات](t.me/IADFI)*\n*[⌔︙لتفعيل البوت عليك اتباع مايلي](t.me/IADFI) *\n*[⌔︙أضِف البوت إلى مجموعتك](t.me/IADFI) *\n*[⌔︙ارفعهُ » مشرف + اكتب تفعيل](t.me/IADFI) *\n*[⌔︙سيتم ترقيتك مالك في البوت](t.me/IADFI) *\n*[⌔︙لكي أعمل وياك بشكل صحيح](t.me/IADFI) *\n*[⌔︙تأكد » من اعطائي حذف الرسائل](t.me/IADFI) *\n*[⌔︙تأكد » من تفعيل الألعاب](t.me/IADFI) *\n*[⌔︙تأكد » من تفعيل الرفع](t.me/IADFI) *\n*[⌔︙تأكد » من تفعيل ردود السورس](t.me/IADFI) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/c_r_o_z_a/15", caption = "⌔︙ غلط القاب هوا-    سكر خشمك و قول كلمة من اختيار الاعبين الي وياك⌔︙",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/c_r_o_z_a/16", caption = "هل انت جاهز للعب مره اخرى ",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/c_r_o_z_a/16", caption = "لقد ربحت مبروك √🎊 ",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/c_r_o_z_a/16", caption = " لقد ربحت مبروك √🎊  نسبه الذكاء 100%",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = 'العب مره اخرى ', callback_data=IdUser..'/guitar'}
},
}
local ban = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..ban.."&media="..JSON.encode(bann).."&reply_markup="..JSON.encode(keyboard))
...
"۝‏﷽إن اللَّه وملائكته يُصلُّون على النبي ياأيُّها الذين امينا صلُّوا عليه وسلِّموا تسليما۝",
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اذكار مره اخرى ', data = IdUser..'/Haiw5'}, },}}
...
"أجمل شيء حصل وياك خلال هذا الاسبوع ؟ ", 
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس هلال ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
...
"عندك شخص تسميه ثالث والدينك؟ ",
  "عندك شخص تسميه ثالث والدينك؟ ",
  "اذا قالو لك تسافر أي مكان تبيه وتاخذ وياك شخص واحد وين بتروح ومين تختار؟ ",
  "أطول مكالمة كم ساعة؟ ",
...
local TextHelp = Reply_Status(replyy,"⌔︙تم كتمه في الگروب  ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = Reply_Status(replyy,"⌔︙تم الغاء كتمه في الگروب ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = Reply_Status(replyy,"⌔︙تم حظر من الگروب  ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = Reply_Status(replyy,"⌔︙تم الغاء حظره من الگروب ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = Reply_Status(replyy,"⌔︙تم تقييده في الگروب  ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = Reply_Status(replyy,"⌔︙تم الغاء تقييده في الگروب ").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
{
{text = '５', data = IdUser..'/help5'}, {text = '６', data = IdUser..'/helpp6'}, 
},
{
...
data = {
{
{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = 't.me/'..chsource..''}, 
},
{
...
data = {
{
{text = 'الحرامية', data = IdUser..'/topzrf'},{text = 'الفلوس', data = IdUser..'/topmon'},
},
{
{text = 'المتزوجين', data = IdUser..'/topzwag'},
},
{
{text = '𓊆 𝑱 𝑩 𝑨𓊇', url="t.me/IADFI"},
},
...
local TextHelp = [[*
⌔︙ مرحبا بك عزيزي مره اخرى 
⌔︙ اختار اوامر التوب الي انت تريدهه 
...
{
{text = 'لعبة البنك', data = IdUser..'/mounybank'}, 
},
{
{text = '𓊆 𝑱 𝑩 𝑨𓊇', url = 't.me/'..chsource..''}, 
},
...
⌔︙ او حسابه ( بالرد ) ↢ لعرض جميع بيانات ومعلومات الحساب البنكي
...
⌔︙أوامر التوب
— — — — — — — — —
⌔︙ترند ↢ يطلع لك اكتر ناس متفاعلين في الگروب

⌔︙توب الحراميه ↢ يطلع لك اكتر ناس سارقين
⌔︙توب الفلوس ↢ يطلع لك اكتر ناس اثرياء بالبوت
⌔︙توب المتزوجين ↢ يطلع لك اغنى 10 ازواج بالگروب
اذا لاحظت اي اخطاء باللعبه راسل المطورين هنا👇.
...
⌔︙ حظر گروب + { الايدي }
⌔︙ غادر ← + { الايدي }
⌔︙ اسم بوتك + غادر بالگروب
⌔︙ تفعيل تعطيل الاشتراك الاجباري
⌔︙ الاشتراك الاجباري
⌔︙ تغيير الاشتراك الاجباري
⌔︙ تفعيل تعطيل الاشتراك الاجباري للگروب
⌔︙ الاشتراك الاجباري للگروب
...
Textk = 'انت ⇿ ✂️\nسورس 𓊆 𝑱 𝑩 𝑨𓊇 ⇿ ✂️\nالنتيجة ⇿ سورس 𓊆 𝑱 𝑩 𝑨𓊇 ⚖️ '..bain..'\n✧'
elseif Descriptioont == "2" then
Textk = 'انت ⇿ ✂️\nسورس 𓊆 𝑱 𝑩 𝑨𓊇 ⇿ 🪨️\nالنتيجة ⇿ 🏆 سورس 𓊆 𝑱 𝑩 𝑨𓊇 🏆\n✧'
else
Textk = 'انت ⇿ ✂️\nسورس 𓊆 𝑱 𝑩 𝑨𓊇 ⇿ 📄️\nالنتيجة ⇿ 🏆 '..bain..' 🏆\n✧'
end
local reply_markup = bot.replyMarkup{
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'بوستات اخرى 🌼', callback_data=IdUser.."/Post"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'لو خيروك اخرى 🍁', callback_data=IdUser.."/Tellme"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رمزيات اخرى', callback_data=IdUser.."/bauat"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رمزيات اخرى', callback_data=IdUser.."/euyilp"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'تويت اخر', callback_data=IdUser.."/tweet"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
au ={type = "audio",media = "https://t.me/DEVJABWA/"..Rrr.."",caption = '*مرحبا اليك ستوري 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ستوري اخر', callback_data=IdUser.."/story"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
au ={type = "audio",media = "https://t.me/JABWA8/"..Rrr.."",caption = '*مرحبا اليك ستوري حب 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ستوري اخر', callback_data=IdUser.."/story2"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
if tonumber(IdUser) == tonumber(UserId) then
Rrr = math.random(4,74)
au ={type = "audio",media = "https://t.me/JABWA7/"..Rrr.."",caption = '*مرحبا اليك ستوري قرأن 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ستوري اخر', callback_data=IdUser.."/story3"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
if tonumber(IdUser) == tonumber(UserId) then
Rrr = math.random(4,74)
au ={type = "audio",media = "https://t.me/JABWA6/"..Rrr.."",caption = '*مرحبا اليك ستوري مضحك 🌝💖*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ستوري اخر', callback_data=IdUser.."/story4"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
bot.answerCallbackQuery(data.id, "⌔︙ تم مغادره البوت من الگروب", true)
...
edit(ChatId,Msg_id,"⌔︙ تم مسح منشئين الگروب", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔︙ تم مسح ادمنيه الگروب", "md",true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'انتقل للمستوى الثاني ', data = IdUser..'C21'},},}}
