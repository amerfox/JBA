...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'مره اخرى', data = msg.sender_id.user_id..'/Haiw5'}, },}}
...
" اعطاء الاخرىن اكثر من ما يتوقعون",
...
"التحلي بلسماح مع الاخرىن او النفس ",
"الاكثار من قول كلمه شكرا ",
" مصافحه الاخرىن بثبات وقوة ",
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢', url = "https://t.me/Sourse1_milano"}
},
}
local msg_id = msg.id/2097152/0.5
...
if text == ('ابلاغ') or text == ('تبليغ') and msg.reply_to_message_id ~= 0 then
	if msg.can_be_deleted_for_all_users == false then
		return bot.sendText(msg.chat_id,msg.id,"\n*⌔︙عذراً البوت ليس ادمن في الگروب يرجى رفعه وتفعيل الصلاحيات له *","md",true)  
	end
	...
	for k, v in pairs(List_Members) do
		if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
			...
			if UserInfo.username then
				Creatorrr = "*⌔︙مالك الگروب ~⪼ @"..UserInfo.username.."*\n"
			else
				Creatorrr = "*⌔︙مالك الگروب ~⪼ *["..UserInfo.first_name.."](tg://user?id="..UserInfo.id..")\n"
			end
			if UserInfo.first_name then
...
keyboardd.inline_keyboard = {
{
{text = 'هل تعلم آخرى 💡', callback_data=senderr.."/Learn"},
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'لو خيروك آخرى 🍁', callback_data=senderr.."/Tellme"},
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'بوستات آخرى 🌼', callback_data=senderr.."/Post"},
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'رمزيات آخرى 👸', callback_data=senderr.."/bauat"},
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'رمزيات آخرى 👼', callback_data=senderr.."/euyilp"},
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'تويت آخرى 🌼', callback_data=senderr.."/tweet"},
},
}
local msg_id = msg.id/2097152/0.5
