...
return send(msg_chat_id,msg_id,'\n*⌔︙هذا الامر يخص { '..Controller_Num(3)..' , مالك الگروب }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔︙تم رفعه سمب في الگروب عقبال ميبقا زي النسوان الي تعبينو 😂  ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔︙تم رفعه قرد في الگروب تعال خدلك موزه  😂  ").Reply,"md",true)  
end
end
if TextMsg == "عره" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔︙تم رفعه عره في الگروب قولو عيب كده 😂  ").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
Creator = "*⌔︙مالك الگروب : @"..UserInfo.username.."*\n"
else
Creator = "⌔︙مالك الگروب : *["..FlterBio(UserInfo.first_name).."](tg://user?id="..UserInfo.id..")\n"
end
...
if statusvar == false then
return send(msg_chat_id,msg_id,'\n*⌔︙هذا الامر يخص { '..Controller_Num(5)..' , مالك الگروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
